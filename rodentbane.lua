...
-- TODO:
--     + Add documentation
--     + Add support for re-binding key
--
...
function rd_bind(modkeys, key, func)
    -- Create binding
...
function binddefault()
    ...
    rd_bind({"Shift"}, "h", {move, "left"})
    rd_bind({"Shift"}, "j", {move, "down"})
    rd_bind({"Shift"}, "k", {move, "up"})
    rd_bind({"Shift"}, "l", {move, "right"})

    -- Undo with u
    rd_bind({}, "u", undo)

    -- Left click with space
    rd_bind({}, "Space", secondaryclick)

    -- Double Left click wiht alt+space
    rd_bind({"Mod1"}, "Space", doublesecondaryclick)

    -- Middle click with Control+space
    rd_bind({"Control"}, "Space", middleclick)

    -- Right click with shift+space
    rd_bind({"Shift"}, "Space", firstclick)
